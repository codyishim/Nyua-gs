...
#include "GCN_Ashton_Chicago_ShotBlock_classes.hpp"
#include "GCN_Ashton_Chicago_ShotBlock_parameters.hpp"
...
void UGCN_Ashton_Chicago_ShotBlock_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Ashton_Chicago_ShotBlock_C", "OnBurst");

	Params::GCN_Ashton_Chicago_ShotBlock_C_OnBurst Parms{};
