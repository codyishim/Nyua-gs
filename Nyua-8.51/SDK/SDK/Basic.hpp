...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05A47438;
	constexpr int32 AppendString      = 0x01CD62A0;
	constexpr int32 GNames            = 0x05A42D08;
	constexpr int32 GWorld            = 0x05B4A1B0;
	constexpr int32 ProcessEvent      = 0x01E7A0F0;
	constexpr int32 ProcessEventIdx   = 0x00000040;
    constexpr int32 Free              = 0x01BFA7D0;
    constexpr int32 Realloc           = 0x01C08880;
}
