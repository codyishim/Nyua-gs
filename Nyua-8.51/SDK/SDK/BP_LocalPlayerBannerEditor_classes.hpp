...
public:
	...
	TMulticastInlineDelegate<void(class FName IconId, class FName ColorId)> CloseBannerEditor;       // 0x0380(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
