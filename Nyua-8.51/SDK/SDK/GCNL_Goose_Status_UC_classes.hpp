...
class AGCNL_Goose_Status_UC_C final : public AFortGameplayCueNotify_Loop
{
public:
...
public:
	void ExecuteUbergraph_GCNL_Goose_Status_UC(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCNL_Goose_Status_UC_C">();
	}
	static class AGCNL_Goose_Status_UC_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AGCNL_Goose_Status_UC_C>();
	}
};
