...
// Package: GCN_Burst_ShipCannon_PlayerLaunch_Impact

#include "Basic.hpp"

#include "GCN_Burst_ShipCannon_PlayerLaunch_Impact_classes.hpp"
#include "GCN_Burst_ShipCannon_PlayerLaunch_Impact_parameters.hpp"
...
void UGCN_Burst_ShipCannon_PlayerLaunch_Impact_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Burst_ShipCannon_PlayerLaunch_Impact_C_OnBurst Parms{};
