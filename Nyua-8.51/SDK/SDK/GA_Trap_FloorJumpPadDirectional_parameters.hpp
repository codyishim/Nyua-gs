...
public:
	...
	class AActor*                                 CallFunc_GetOwningActorFromActorInfo_ReturnValue_1; // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABuildingTrap*                          K2Node_DynamicCast_AsBuilding_Trap_1;              // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerPawn*                        K2Node_CustomEvent_Player;                         // 0x0108(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_DoesSocketExist_ReturnValue_1;            // 0x0199(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FGameplayTag                           K2Node_CustomEvent_ApplicationTag;                 // 0x01F8(0x0008)(NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0220(0x0010)(ZeroConstructor, NoDestructor)
	...
	struct FGameplayAbilityTargetDataHandle       K2Node_CustomEvent_TargetData_1;                   // 0x0240(0x0028)(ConstParm)
	struct FGameplayTag                           K2Node_CustomEvent_ApplicationTag_1;               // 0x0268(0x0008)(NoDestructor, HasGetValueTypeHash)
};
