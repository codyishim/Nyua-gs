...
void UGAB_Melee_Tool_LeapAttack_Athena_C::DoesFortPawnHavePermissionToEditWorld(bool* bHasPermissionToEditWorld)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GAB_Melee_Tool_LeapAttack_Athena_C", "DoesFortPawnHavePermissionToEditWorld");

	Params::GAB_Melee_Tool_LeapAttack_Athena_C_DoesFortPawnHavePermissionToEditWorld Parms{};
...
bool UGAB_Melee_Tool_LeapAttack_Athena_C::K2_CanActivateAbility(const struct FGameplayAbilityActorInfo& ActorInfo, struct FGameplayTagContainer* RelevantTags) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GAB_Melee_Tool_LeapAttack_Athena_C", "K2_CanActivateAbility");

	Params::GAB_Melee_Tool_LeapAttack_Athena_C_K2_CanActivateAbility Parms{};
