...
#include "GCN_Ashton_Chicago_ShieldToss_classes.hpp"
#include "GCN_Ashton_Chicago_ShieldToss_parameters.hpp"
...
void UGCN_Ashton_Chicago_ShieldToss_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Ashton_Chicago_ShieldToss_C_OnBurst Parms{};
