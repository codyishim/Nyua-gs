...
class UGCN_Burst_ShipCannon_PlayerLaunch_Impact_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Burst_ShipCannon_PlayerLaunch_Impact_C">();
	}
	static class UGCN_Burst_ShipCannon_PlayerLaunch_Impact_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Burst_ShipCannon_PlayerLaunch_Impact_C>();
	}
};
