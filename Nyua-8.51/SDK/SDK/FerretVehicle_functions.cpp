...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const float                             OverheatValueForMID_0                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AFerretVehicle_C::SendOverheartValueToMaterials(const float OverheatValueForMID_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.OverheatValueForMID_0 = OverheatValueForMID_0;
...
void AFerretVehicle_C::GetIconPlacement(class AActor* SelfActor, class AActor* ViewingActor, struct FVector* OutLocation, struct FVector* OutExtents) const
{
	static class UFunction* Func = nullptr;
