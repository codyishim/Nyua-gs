...
class UGCN_Burst_Goose_Healthpack_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Burst_Goose_Healthpack_C">();
	}
	static class UGCN_Burst_Goose_Healthpack_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Burst_Goose_Healthpack_C>();
	}
};
