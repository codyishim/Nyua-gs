...
class AGCNL_Goose_Status_VR_C final : public AFortGameplayCueNotify_Loop
{
public:
...
public:
	void ExecuteUbergraph_GCNL_Goose_Status_VR(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCNL_Goose_Status_VR_C">();
	}
	static class AGCNL_Goose_Status_VR_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AGCNL_Goose_Status_VR_C>();
	}
};
