...
void UPlayerSurveyPanelContentsAnswerRatingWidget_C::HandleAnswerChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerSurveyPanelContentsAnswerRatingWidget_C", "HandleAnswerChanged");
...
void UPlayerSurveyPanelContentsAnswerRatingWidget_C::HandleQAChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerSurveyPanelContentsAnswerRatingWidget_C", "HandleQAChanged");
...
void UPlayerSurveyPanelContentsAnswerRatingWidget_C::UpdateAnswerDisplay()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerSurveyPanelContentsAnswerRatingWidget_C", "UpdateAnswerDisplay");
...
void UPlayerSurveyPanelContentsAnswerRatingWidget_C::GetCurrentQuestion(class UFortPlayerSurveyQuestionMultipleChoice** Result) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerSurveyPanelContentsAnswerRatingWidget_C", "GetCurrentQuestion");

	Params::PlayerSurveyPanelContentsAnswerRatingWidget_C_GetCurrentQuestion Parms{};
...
// struct FFortPlayerSurveyAnswerMultipleChoice*Result                                                 (Parm, OutParm, NoDestructor)

void UPlayerSurveyPanelContentsAnswerRatingWidget_C::GetCurrentAnswer(bool* IsSet, struct FFortPlayerSurveyAnswerMultipleChoice* Result) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerSurveyPanelContentsAnswerRatingWidget_C", "GetCurrentAnswer");

	Params::PlayerSurveyPanelContentsAnswerRatingWidget_C_GetCurrentAnswer Parms{};
