...
// 0x0028 (0x0028 - 0x0000)
struct FAthenaReplayActionFeedRowData final
{
public:
	EFortReplayEventType                          EventType;                                         // 0x0000(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	float                                         EventTime;                                         // 0x0004(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InstigatorName;                                    // 0x0008(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VictimName;                                        // 0x0018(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FJsonObjectWrapper                     C;                                                 // 0x0008(0x0020)(NativeAccessSpecifierPublic)
};
...
// 0x0028 (0x0028 - 0x0000)
struct FFortPlayerSurveyCMSDataQuestionMultipleChoice final
{
public:
	class FText                                   T;                                                 // 0x0000(0x0018)(NativeAccessSpecifierPublic)
	TArray<struct FFortPlayerSurveyCMSDataQuestionChoice> C;                                         // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
