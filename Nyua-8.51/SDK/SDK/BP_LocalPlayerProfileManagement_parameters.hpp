...
public:
	...
	bool                                          CallFunc_ToggleLocalPlayerParticipation_bIsParticipating; // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FFortTeamMemberInfo                    K2Node_Event_NewInfo;                              // 0x0090(0x0200)(HasGetValueTypeHash)
	int32                                         CallFunc_GetHomebaseRating_Rating;                 // 0x0290(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetHomebaseRating_ProgressFraction;       // 0x0294(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetHomebaseRating_ReturnValue;            // 0x0298(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function BP_LocalPlayerProfileManagement.BP_LocalPlayerProfileManagement_C.OnPlayerInfoChanged
// 0x0200 (0x0200 - 0x0000)
struct BP_LocalPlayerProfileManagement_C_OnPlayerInfoChanged final
{
public:
...
struct BP_LocalPlayerProfileManagement_C_BndEvt__ParticipationButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature final
{
public:
...
public:
	...
	bool                                          CallFunc_CanLocalPlayerChangeParticipation_ReturnValue; // 0x0006(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_7[0x1];                                        // 0x0007(0x0001)(Fixing Size After Last Property [ Dumper-8 ])
	class FText                                   CallFunc_GetParticipationText_ParticipationText;   // 0x0008(0x0018)()
	ESlateVisibility                              K2Node_Select_Default;                             // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_CanLocalPlayerLeaveParty_ReturnValue;     // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	TArray<class UFortAccountItem*>               CallFunc_GetAccountItemsByType_Items_1;            // 0x0060(0x0010)(ZeroConstructor, ReferenceParm)
};

// Function BP_LocalPlayerProfileManagement.BP_LocalPlayerProfileManagement_C.CanLocalPlayerLeaveParty
// 0x0040 (0x0040 - 0x0000)
struct BP_LocalPlayerProfileManagement_C_CanLocalPlayerLeaveParty final
{
public:
	...
	bool                                          CallFunc_IsInLobby_ReturnValue;                    // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1A[0x6];                                       // 0x001A(0x0006)(Fixing Size After Last Property [ Dumper-8 ])
	class UFortUIDataConfigurationContext*        CallFunc_GetContext_ReturnValue_2;                 // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortPartyContext*                      CallFunc_GetContext_ReturnValue_3;                 // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// 0x0070 (0x0070 - 0x0000)
struct BP_LocalPlayerProfileManagement_C_GetParticipationText final
{
public:
	class FText                                   ParticipationText;                                 // 0x0000(0x0018)(Parm, OutParm)
	...
	bool                                          CallFunc_IsLocalPlayerParticipatingInParty_ReturnValue; // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
