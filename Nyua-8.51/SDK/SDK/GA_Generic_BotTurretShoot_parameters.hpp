...
public:
	...
	struct FHitResult                             CallFunc_GetHitResultFromTargetData_ReturnValue;   // 0x0090(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	TArray<struct FActiveGameplayEffectHandle>    CallFunc_ApplyGameplayEffectContainer_ReturnValue; // 0x0118(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	class AB_BGA_BotTurret_Parent_C*              K2Node_DynamicCast_AsB_BGA_Bot_Turret_Parent;      // 0x01C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAbilityTargetDataHandle       K2Node_CustomEvent_TargetData_1;                   // 0x01D8(0x0028)(ConstParm)
	struct FGameplayTag                           K2Node_CustomEvent_ApplicationTag_1;               // 0x0200(0x0008)(NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0208(0x0010)(ZeroConstructor, NoDestructor)
};
