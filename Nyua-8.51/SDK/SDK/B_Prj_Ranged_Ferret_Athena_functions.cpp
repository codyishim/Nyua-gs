...
// EDualWeaponHand                         Index_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Prj_Ranged_Ferret_Athena_C::SetMaterialParameters(const struct FVector& Left, const struct FVector& Right, EDualWeaponHand Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Ranged_Ferret_Athena_C", "SetMaterialParameters");

	Params::B_Prj_Ranged_Ferret_Athena_C_SetMaterialParameters Parms{};
