...
#include "GCN_Carmine_SpawnInGemFlare_classes.hpp"
#include "GCN_Carmine_SpawnInGemFlare_parameters.hpp"
...
void UGCN_Carmine_SpawnInGemFlare_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Carmine_SpawnInGemFlare_C", "OnBurst");

	Params::GCN_Carmine_SpawnInGemFlare_C_OnBurst Parms{};
