...
public:
	...
	uint8                                         Pad_B8[0x3D0];                                     // 0x00B8(0x03D0)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0488(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0490(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x0498(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x04A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_1A8[0x70];                                     // 0x01A8(0x0070)(Fixing Struct Size After Last Property [ Dumper-8 ])
