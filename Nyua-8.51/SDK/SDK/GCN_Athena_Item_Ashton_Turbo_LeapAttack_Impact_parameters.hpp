...
struct GCN_Athena_Item_Ashton_Turbo_LeapAttack_Impact_C_OnBurst final
{
public:
	...
	struct FHitResult                             CallFunc_K2_AddWorldOffset_SweepHitResult;         // 0x0118(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	TArray<EObjectTypeQuery>                      K2Node_MakeArray_Array;                            // 0x0288(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue_1;       // 0x03A0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x03AC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue_1;       // 0x03B8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                             CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x03C4(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
